...
/* PIDs consist of a machine portion (high 12 bits) and a local */
/* id portion (low 20 bits). This all assumes that an int is 32 */
/* bits wide.                                                    */


/* temporary check to see if making this a 64-bit PID will be a quick fix */
