...
forktest(void)
{
  ...
  36:	3be50513          	add	a0,a0,958 # 3f0 <trace+0x8>
  ...
  58:	3ac50513          	add	a0,a0,940 # 400 <trace+0x18>
  ...
  94:	3c050513          	add	a0,a0,960 # 450 <trace+0x68>
  ...
  ac:	37850513          	add	a0,a0,888 # 420 <trace+0x38>
  ...
  be:	37e50513          	add	a0,a0,894 # 438 <trace+0x50>
