...
main(int argc, char *argv[])
{
  ...
  3c:	84858593          	add	a1,a1,-1976 # 880 <malloc+0xde>
  40:	4509                	li	a0,2
  42:	682000ef          	jal	6c4 <fprintf>
    exit(1);
  46:	4505                	li	a0,1
  ...
  52:	84a58593          	add	a1,a1,-1974 # 898 <malloc+0xf6>
  56:	4509                	li	a0,2
  58:	66c000ef          	jal	6c4 <fprintf>
      break;
    }
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a4:	0805c763          	bltz	a1,432 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 3b8:	50c50513          	add	a0,a0,1292 # 8c0 <digits>
 3bc:	883a                	mv	a6,a4
 ...
 3f4:	0028071b          	addw	a4,a6,2
  ...
  while(--i >= 0)
 3f8:	02e05663          	blez	a4,424 <printint+0x92>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 450:	e466                	sd	s9,8(sp)
 452:	e06a                	sd	s10,0(sp)
 454:	1080                	add	s0,sp,96
  char *s;
 ...
 45a:	24090763          	beqz	s2,6a8 <vprintf+0x26e>
 45e:	8b2a                	mv	s6,a0
 460:	8a2e                	mv	s4,a1
 462:	8bb2                	mv	s7,a2
  state = 0;
 ...
 476:	a005                	j	496 <vprintf+0x5c>
        putc(fd, c0);
 478:	85ca                	mv	a1,s2
 47a:	855a                	mv	a0,s6
 47c:	ef9ff0ef          	jal	374 <putc>
 480:	a019                	j	486 <vprintf+0x4c>
    } else if(state == '%'){
 482:	03598263          	beq	s3,s5,4a6 <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
 486:	2485                	addw	s1,s1,1
 488:	8726                	mv	a4,s1
 48a:	009a07b3          	add	a5,s4,s1
 48e:	0007c903          	lbu	s2,0(a5)
 492:	20090b63          	beqz	s2,6a8 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
 496:	0009079b          	sext.w	a5,s2
    if(state == 0){
 49a:	fe0994e3          	bnez	s3,482 <vprintf+0x48>
      if(c0 == '%'){
 49e:	fd579de3          	bne	a5,s5,478 <vprintf+0x3e>
        state = '%';
 4a2:	89be                	mv	s3,a5
 4a4:	b7cd                	j	486 <vprintf+0x4c>
      if(c0) c1 = fmt[i+1] & 0xff;
 4a6:	c7c9                	beqz	a5,530 <vprintf+0xf6>
 4a8:	00ea06b3          	add	a3,s4,a4
 4ac:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
 4b0:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 4b2:	c681                	beqz	a3,4ba <vprintf+0x80>
 4b4:	9752                	add	a4,a4,s4
 4b6:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 4ba:	03878f63          	beq	a5,s8,4f8 <vprintf+0xbe>
      } else if(c0 == 'l' && c1 == 'd'){
 4be:	05978963          	beq	a5,s9,510 <vprintf+0xd6>
 ...
 4c6:	0ee78363          	beq	a5,a4,5ac <vprintf+0x172>
 ...
 4ce:	12e78563          	beq	a5,a4,5f8 <vprintf+0x1be>
 ...
 4d6:	14e78a63          	beq	a5,a4,62a <vprintf+0x1f0>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
 4da:	07300713          	li	a4,115
 4de:	18e78863          	beq	a5,a4,66e <vprintf+0x234>
 ...
 4e6:	04e79563          	bne	a5,a4,530 <vprintf+0xf6>
        putc(fd, '%');
 4ea:	02500593          	li	a1,37
 4ee:	855a                	mv	a0,s6
 4f0:	e85ff0ef          	jal	374 <putc>
 ...
 504:	855a                	mv	a0,s6
 506:	e8dff0ef          	jal	392 <printint>
 50a:	8bca                	mv	s7,s2
      state = 0;
 50c:	4981                	li	s3,0
 50e:	bfa5                	j	486 <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'd'){
 510:	06400793          	li	a5,100
 514:	02f68963          	beq	a3,a5,546 <vprintf+0x10c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 518:	06c00793          	li	a5,108
 51c:	04f68263          	beq	a3,a5,560 <vprintf+0x126>
      } else if(c0 == 'l' && c1 == 'u'){
 520:	07500793          	li	a5,117
 524:	0af68063          	beq	a3,a5,5c4 <vprintf+0x18a>
      } else if(c0 == 'l' && c1 == 'x'){
 528:	07800793          	li	a5,120
 52c:	0ef68263          	beq	a3,a5,610 <vprintf+0x1d6>
        putc(fd, '%');
 ...
 53a:	85ca                	mv	a1,s2
 53c:	855a                	mv	a0,s6
 53e:	e37ff0ef          	jal	374 <putc>
      state = 0;
 542:	4981                	li	s3,0
 544:	b789                	j	486 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 55c:	4981                	li	s3,0
        i += 1;
 55e:	b725                	j	486 <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 560:	06400793          	li	a5,100
 564:	02f60763          	beq	a2,a5,592 <vprintf+0x158>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 568:	07500793          	li	a5,117
 56c:	06f60963          	beq	a2,a5,5de <vprintf+0x1a4>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 570:	07800793          	li	a5,120
 574:	faf61ee3          	bne	a2,a5,530 <vprintf+0xf6>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 5b8:	855a                	mv	a0,s6
 5ba:	dd9ff0ef          	jal	392 <printint>
 5be:	8bca                	mv	s7,s2
      state = 0;
 5c0:	4981                	li	s3,0
 5c2:	b5d1                	j	486 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 604:	855a                	mv	a0,s6
 606:	d8dff0ef          	jal	392 <printint>
 60a:	8bca                	mv	s7,s2
      state = 0;
 60c:	4981                	li	s3,0
 60e:	bda5                	j	486 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 626:	4981                	li	s3,0
        i += 1;
 628:	bdb9                	j	486 <vprintf+0x4c>
        printptr(fd, va_arg(ap, uint64));
 62a:	008b8d13          	add	s10,s7,8
 62e:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
 632:	03000593          	li	a1,48
 636:	855a                	mv	a0,s6
 638:	d3dff0ef          	jal	374 <putc>
  putc(fd, 'x');
 63c:	07800593          	li	a1,120
 640:	855a                	mv	a0,s6
 642:	d33ff0ef          	jal	374 <putc>
 646:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 648:	00000b97          	auipc	s7,0x0
 64c:	278b8b93          	add	s7,s7,632 # 8c0 <digits>
 650:	03c9d793          	srl	a5,s3,0x3c
 654:	97de                	add	a5,a5,s7
 656:	0007c583          	lbu	a1,0(a5)
 65a:	855a                	mv	a0,s6
 65c:	d19ff0ef          	jal	374 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 660:	0992                	sll	s3,s3,0x4
 662:	397d                	addw	s2,s2,-1
 664:	fe0916e3          	bnez	s2,650 <vprintf+0x216>
        printptr(fd, va_arg(ap, uint64));
 668:	8bea                	mv	s7,s10
      state = 0;
 66a:	4981                	li	s3,0
 66c:	bd29                	j	486 <vprintf+0x4c>
        if((s = va_arg(ap, char*)) == 0)
 ...
 68e:	8bce                	mv	s7,s3
      state = 0;
 690:	4981                	li	s3,0
 692:	bbd5                	j	486 <vprintf+0x4c>
          s = "(null)";
 694:	00000917          	auipc	s2,0x0
 698:	22490913          	add	s2,s2,548 # 8b8 <malloc+0x116>
        for(; *s; s++)
...
printf(const char *fmt, ...)
{
 ...
 710:	85aa                	mv	a1,a0
 712:	4505                	li	a0,1
 714:	d27ff0ef          	jal	43a <vprintf>
}
 718:	60e2                	ld	ra,24(sp)
 71a:	6442                	ld	s0,16(sp)
 71c:	6125                	add	sp,sp,96
 71e:	8082                	ret
 ...
 756:	00e6ea63          	bltu	a3,a4,76a <free+0x4a>
{
 ...
 76e:	6390                	ld	a2,0(a5)
 770:	02059813          	sll	a6,a1,0x20
 774:	01c85713          	srl	a4,a6,0x1c
 ...
 77e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 782:	4790                	lw	a2,8(a5)
 784:	02061593          	sll	a1,a2,0x20
 788:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 7b0:	e456                	sd	s5,8(sp)
 7b2:	e05a                	sd	s6,0(sp)
 7b4:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 7b6:	02051493          	sll	s1,a0,0x20
 7ba:	9081                	srl	s1,s1,0x20
 7bc:	04bd                	add	s1,s1,15
 7be:	8091                	srl	s1,s1,0x4
 7c0:	0014899b          	addw	s3,s1,1
 ...
 7f2:	81290913          	add	s2,s2,-2030 # 1000 <freep>
  if(p == (char*)-1)
 7f6:	5afd                	li	s5,-1
 7f8:	a885                	j	868 <malloc+0xc6>
    base.s.ptr = freep = prevp = &base;
 7fa:	00001797          	auipc	a5,0x1
 7fe:	81678793          	add	a5,a5,-2026 # 1010 <base>
